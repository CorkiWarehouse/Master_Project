...
def parse_args():
    ...
    '''
    parser.add_argument("--env_name", type=str, default="CARS", help="the environment model (CARS)")
    parser.add_argument("--is_original_dynamics", type=int, default=0, help="original or new dynamics. 0: original, 1: new")
    parser.add_argument("--horizon", type=int, default=3, help="horizon of mean field games")
    ...
    parser.add_argument("--max_num_game_plays", type=int, default=2, help="maximal number of sampled game_plays")
