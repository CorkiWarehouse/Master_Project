...
def parse_args():
    ...
    '''
    parser.add_argument("--env_name", type=str, default="ISINGNEW", help="the environment model (LR)")
    parser.add_argument("--is_original_dynamics", type=int, default=0, help="original or new dynamics. 0: original, 1: new")
    parser.add_argument("--horizon", type=int, default=10, help="horizon of mean field games")
    parser.add_argument("--gamma", type=float, default=0.99, help="discount factor")
    parser.add_argument("--beta", type=float, default=0.99, help="entropy regularisation strength")
    ...
    '''
    parser.add_argument("--max_epoch", type=int, default=50, help="maximum epoch length")
